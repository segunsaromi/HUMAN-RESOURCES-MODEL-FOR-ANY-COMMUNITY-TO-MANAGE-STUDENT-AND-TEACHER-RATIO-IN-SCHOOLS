...
<div style="background-image: url(onlineapp/ccslogo/header.jpg); background-repeat: no-repeat center center; background-size: cover; height: 200px"></div>
	...
	<div class="container">
	  <div class="col-lg-12">
		...
		<div class="row">
		<br>
		<h4 align="center">TEACHER / SCHOOL FORM</h4><br>
			<div id="form-content">
...
<?php $querysteacher=mysqli_query($conn,"SELECT * FROM teacher_tbl WHERE status='0' ORDER by teacher_name ASC");  
while($rowteacher=mysqli_fetch_array($querysteacher)) {?>  

  <option value="<?php echo $rowteacher['teacher_id']; ?>"><?php echo $rowteacher['teacher_name']; ?></option>
<?php }?>
</select>				
</div>
...
<?php $querysschool=mysqli_query($conn,"SELECT * FROM school_tbl ORDER by school_name ASC");  
