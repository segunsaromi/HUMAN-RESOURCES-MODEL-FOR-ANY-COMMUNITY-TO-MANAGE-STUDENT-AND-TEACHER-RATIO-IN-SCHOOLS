...
<table width="100%" border="0" class="table table-striped">
  <tr>
    <td colspan="6">EDIT/DELETE TEACHER RECORD</td>
    </tr>
  <tr>
...
<?php 
$conn = mysqli_connect('localhost','root','','lagoseduboard');
$detaila = mysqli_query($conn,"SELECT * FROM teacher_tbl");
...
<td><a href="teacher_edit.php?page=null&teacher_id=<?php echo $teacher_id; ?>" title="<?php echo $teacher_id; ?>">-|-</a></td>  
<td><a href="teacher_delete.php?page=null&teacher_id=<?php echo $teacher_id; ?>" title="<?php echo $teacher_id; ?>">-|-</a></td>  </tr> <?php }?>
</table><br><br>
		  </div>
