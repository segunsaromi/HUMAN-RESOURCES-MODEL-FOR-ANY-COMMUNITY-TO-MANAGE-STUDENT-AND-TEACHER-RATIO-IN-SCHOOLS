...
if (mysqli_num_rows($exist) > 0){$bankinsert=mysqli_query($conn,"UPDATE assign_tbl SET teacher_name='$teacher_name',teacher_id='$teacher_id',school_name='$school_name',school_id='$school_id' WHERE assign_id='$assign_id'") or die(mysqli_error($conn));} 

else{			

		
	$bankinsert=mysqli_query($conn,"INSERT INTO assign_tbl (teacher_name,teacher_id,school_name,school_id) VALUES ('$teacher_name','$teacher_id','$school_name','$school_id')") or die(mysqli_error($conn));
